...
!  non-executable statements
 ...
 3110 FORMAT( ( 10I8 ) )
 3120 FORMAT( ( 1P, 4D18.10 ) )
 3121 FORMAT( ( 1P, 4E18.10 ) )
!3120 FORMAT( ( 1P, 4D16.8 ) )
!3121 FORMAT( ( 1P, 4E16.8 ) )
 3130 FORMAT( ( 72L1 ) )
 3140 FORMAT( ( 8A10 ) )
 3160 FORMAT( 1P, 2D18.10 )
 3161 FORMAT( 1P, 2E18.10 )
